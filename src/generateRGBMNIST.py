...
torch.save(train_x, 'RGBMnistData/train_'+colorName+'_x.pt')
torch.save(train_y, 'RGBMnistData/train_'+colorName+'_y.pt')
torch.save(test_x, 'RGBMnistData/test_'+colorName+'_x.pt')
torch.save(test_y, 'RGBMnistData/test_'+colorName+'_y.pt')